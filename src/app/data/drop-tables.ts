export const skeletonDropTable = {
  ...
  armor: [
    ...
    { name: 'Leather Armor', defense: 8, attack: 0, rarity: 'Rare', probability: 0.3, image: './reward/leather.png' },
    { name: 'Chainmail Armor', defense: 10, attack: 0, rarity: 'Legendary', probability: 0.2, image: './reward/chainmail.png' }
  ]
};
...
export const zombieDropTable = {
  ...
  armor: [
    { name: 'Scraps Armor', defense: 9, attack: 0, rarity: 'Common', probability: 0.6, image: './reward/base-armor.png' },
    { name: 'Rotten Leather', defense: 12, attack: 0, rarity: 'Rare', probability: 0.25, image: './reward/rotten-leather.png' },
...
export const vampireDropTable = {
  ...
  armor: [
    { name: 'Dark Cloak', defense: 10, attack: 0, rarity: 'Common', probability: 0.5, image: './reward/dark-cloak.png' },
    { name: 'Shadow Armor', defense: 13, attack: 0, rarity: 'Rare', probability: 0.35, image: './reward/shadow-armor.png' },
    { name: 'Crimson Robe', defense: 16, attack: 0, rarity: 'Legendary', probability: 0.15, image: './reward/crimson-robe.png' }
  ]
};
...
export const dragonDropTable = {
  ...
  armor: [
    { name: 'Dragon Hide', defense: 24, attack: 0, rarity: 'Common', probability: 0.5, image: './reward/dragon-hide.png' },
